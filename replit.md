...
## Recent Changes
- 2026-01-08: Added budget selector to Plan tab - Mindful (budget-conscious), Balanced (moderate), Elevated (luxury)
- 2026-01-08: PlanPlaceCard component for consistent place rendering in plans (saved places + AI recommendations)
...
- 2026-01-08: Plans schema extended with peopleCount, tripPurpose, budget, includeRecommendations fields
